public protocol NavigationControlling<ViewController>: ViewControlling {
...
public extension NavigationControlling {
    ...
    @discardableResult
    func popToViewcontroller(viewController: ViewController) -> [ViewController]? {
